...
const MyPDFComponent = (props) => {

  // const token = useSelector((state) => state.auth.token)
  // const [cek, setCek] = useState(true)

  // const getData = () => {
  //   if(!props.idkaryawan) return message.error("Please choose karyawan")
  //   if(!props.fileName) return message.error("Please insert filename to download")

  //   PdfAdmin(props.idkaryawan, props.date.month, props.date.year, token)
  //   .then((res) => {
  //     setCek(false); 
  ...
  return (
    <div>
      ...
      {/* {cek ? <Button onClick={() => getData()}>Cek Data</Button> : } */}
